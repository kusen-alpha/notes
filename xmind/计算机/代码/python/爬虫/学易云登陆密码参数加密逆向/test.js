...
dpl10, lr10, hexatrigesimalToChar, hexToChar, highBitMasks, lowBitMasks, RSAAPP;
...
function get_pwd(passwd, rsaPublicKey) {
setMaxDigits(262);
var key = new RSAKeyPair(rsaPublicKey.exponent, "", rsaPublicKey.modulus, parseInt(rsaPublicKey.dwKeySize));
var ciphertext = encryptedString(key, passwd, RSAAPP.PKCS1Padding, RSAAPP.RawEncoding);
